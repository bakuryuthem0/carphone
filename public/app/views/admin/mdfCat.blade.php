			...
			<div class="col-xs-8 contCentrado contDeColor" style="margin-top:2em;">
				...
				<div class="col-xs-12 textoNegro">
					<div class="col-xs-12">
						...
						<p class="textoPromedio">Llene el siguiente formulario para editar la marca: {{ $phon->nombre }}.</p>
					</div>						
				</div>
				<form action="{{ URL::to('modificar-marca/'.$phon->id.'/enviar') }}" id="formRegister" method="POST" enctype="multipart/form-data">
					<div class="col-xs-12 formulario textoNegro">
						<div class="col-xs-12 inputRegister">
							<p class="textoPromedio">Nombre de la marca:</p>
						</div>
						<div class="col-xs-12 inputRegister">
							{{ Form::text('name_cat',$phon->nombre,array('data-trigger' => "blur",'class' => 'form-control cat_nomb inputForm inputFondoNegro','placeholder' => 'Nombre de la marca',)) }}
